...
namespace UnityTerminal
{
    ...
    class RetroTerminal : RenderableTerminal
    {
        ...
        // public override Vector2Int size => _display.size;
        ...
        public override void render()
        {
            ...
            _display.render((x, y, glyph) =>
            {
                ...
                spr.transform.localPosition = new Vector3((x - width * 0.5f + 0.5f) * _charWidth * _scale / 100f, (height * 0.5f - y - 0.5f) * _charHeight * _scale / 100f, 0f);
        ...
        public override Vector2Int pixelToChar(Vector2Int pixel) =>
            new Vector2Int(pixel.x / _charWidth, pixel.y / _charHeight);
